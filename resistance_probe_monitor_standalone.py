#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Resistance Probe Monitoring Tools for the River System Control and Monitoring Software Version 0.9.1
...
def RunStandalone():
    ...
    FileName, ServerAddress, NumberOfReadingsToTake = functions.handle_cmdline_options("resistance_probe_monitor_standalone.py")
    ...
    FileName, RecordingsFile = CoreTools.greet_and_get_filename("Resistance Probe Monitor", FileName)
    ...
    Probe.SetPins((15, 17, 27, 22, 23, 24, 10, 9, 25, 11))
