#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Float Switch Monitoring Tools for the River System Control and Monitoring Software Version 1.0
...
def usage():
    ...
    print("\nUsage: float_switch_monitor_standalone.py [OPTION]\n\n")
    print("Options:\n")
    ...
    print("float_switch_monitor_standalone.py is released under the GNU GPL Version 3")
...
def RunStandalone():
    ...
    from Tools.monitortools import FloatSwitchMonitor
    ...
    MonitorThread = FloatSwitchMonitor(Probe, NumberOfReadingsToTake, ReadingInterval=ReadingInterval)
    time.sleep(2)
