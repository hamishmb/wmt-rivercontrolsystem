...
TEST_GATEVALVE_DATA = [
    ...
    ["VALVE4:V4", "Test", (2, 3, 4), 5, 99, 10, 2.0],
    ["VALVE5:V4", "Test", (3, 4, 5), 6, 98, 9, 2.1],
    ["VALVE1:V1", "Test", (5, 6, 7), 7, 97, 8, 2.2],
    ["VALVE2:V2", "Test", (6, 7, 8), 8, 96, 7, 2.3],
    ["VALVE3:V3", "Test", (7, 8, 9), 9, 95, 6, 2.4],
    ["VALVE6:V6", "Test", (8, 9, 10), 1, 94, 5, 2.5],
    ["VALVE7:V7", "Test", (9, 10, 11), 2, 93, 9, 2.6],
    ["VALVE8:V8", "Test", (10, 11, 12), 3, 92, 9, 2.7],
    ["VALVE9:V9", "Test", (11, 12, 13), 4, 91, 9, 2.8],
    ["VALVE10:V10", "Test", (12, 13, 14), 6, 90, 9, 2.9],
    ["VALVE11:V11", "Test", (13, 14, 15), 6, 98, 9, 3],
    ["VALVE12:V12", "Test", (14, 15, 16), 6, 98, 9, 3.1],
    ["VALVE13:V13", "Test", (2, 4, 5), 6, 98, 9, 3.2],
    ["VALVE14:V14", "Test", (6, 4, 5), 6, 98, 9, 3.3],
    ["VALVE15:V15", "Test", (9, 4, 5), 6, 98, 9, 4.1],
    ["VALVE16:V16", "Test", (19, 4, 5), 6, 98, 9, 3.7],
    ["VALVE17:V17", "Test", (3, 12, 6), 6, 98, 9, 5.5]
]

TEST_GATEVALVE_BAD_DATA = [
    #ID, Name, Pins, Tolerance, Max, Min, Voltage
    #Invalid pins.
    ["VALVE4:V4", "Test", (0, 3, -4), 5, 99, 10, 2.0],
    ["VALVE5:V5", "Test", (3, 4, -5), 6, 98, 9, 2.1],
    ["VALVE1:V1", "Test", (5, 6), 7, 97, 8, 2.2],
    ["VALVE2:V2", "Test", (), 8, 96, 7, 2.3],
    ["VALVE3:V3", "Test", True, 9, 95, 6, 2.4],

    #Invalid values for Tolerance.
    ["VALVE6:V6", "Test", (8, 9, 10), 0, 94, 5, 2.5],
    ["VALVE7:V7", "Test", (9, 10, 11), -18, 93, 9, 2.6],
    ["VALVE8:V8", "Test", (10, 11, 12), True, 92, 9, 2.7],
    ["VALVE9:V9", "Test", (11, 12, 13), 15, 91, 9, 2.8],
    ["VALVE10:V10", "Test", (12, 13, 14), 11.7, 90, 9, 2.9],
    ["VALVE11:V11", "Test", (13, 14, 15), {}, 98, 9, 3],

    #Invalid values for Max Open.
    ["VALVE12:V12", "Test", (14, 15, 16), 6.4, 89, 9, 3.1],
    ["VALVE13:V13", "Test", (2, 4, 5), 6, 100, 9, 3.2],
    ["VALVE14:V14", "Test", (6, 4, 5), 6, -98, 9, 3.3],
    ["VALVE15:V15", "Test", (9, 4, 5), 6, 50, 9, 4.1],
    ["VALVE16:V16", "Test", (19, 4, 5), 6, False, 9, 3.7],

    #Invalid values for Min Open.
    ["VALVE17:V17", "Test", (3, 12, 6), 6, 98, 0, 5.5],
    ["VALVE17:V17", "Test", (3, 12, 6), 6, 98, 11, 5.5],
    ["VALVE17:V17", "Test", (3, 12, 6), 6, 98, 60, 5.5],
    ["VALVE17:V17", "Test", (3, 12, 6), 6, 98, -78, 5.5],
    ["VALVE17:V17", "Test", (3, 12, 6), 6, 98, {}, 5.5],
    ["VALVE17:V17", "Test", (3, 12, 6), 6, 98, 9.5, 5.5],

    #Invalid values for Reference Voltage.
    ["VALVE17:V17", "Test", (3, 12, 6), 6, 98, 9, -5.5],
    ["VALVE17:V17", "Test", (3, 12, 6), 6, 98, 9, 1.9],
    ["VALVE17:V17", "Test", (3, 12, 6), 6, 98, 9, 5.6],
    ["VALVE17:V17", "Test", (3, 12, 6), 6, 98, 9, False],
    ["VALVE17:V17", "Test", (3, 12, 6), 6, 98, 9, ()],
