#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Capacitive Probe Monitoring Tools for the River System Control and Monitoring Software Version 0.9.1
...
def RunStandalone():
    ...
    FileName, ServerAddress, NumberOfReadingsToTake = functions.handle_cmdline_options("capacitive_probe_monitor_standalone.py")
