...
class TestReading(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.reading = coretools.Reading(self.time, 1, "SUMP:M0", "100", "OK")
        self.reading_2 = coretools.Reading(self.time, 6, "SUMP:M1", "200", "OK")
        self.reading_3 = coretools.Reading(self.time, 6, "SUMP:M0", "100", "OK")
    ...
    def test_constructor_1(self):
        ...
        for dataset in data.TEST_READING_DATA:
            ...
            new_reading = coretools.Reading(time, tick, _id, value, status)
